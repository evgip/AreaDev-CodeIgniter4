...
class AuthModel extends Model{
    ...
    protected $allowedFields = ['nickname', 'name', 'email', 'password', 'reset_token', 'reset_expire', 'activated', 'activate_token', 'activate_expire', 'role', 'about', 'updated_at', 'deleted_at'];
