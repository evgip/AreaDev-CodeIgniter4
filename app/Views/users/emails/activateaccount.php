    ...
    <container>
        ...
        <row>
            <columns>
                ...
                <spacer size="16"></spacer>
                <p class="textcenter" style="font-family:Lato,sans-serif;text-align:center">Hi <?php echo $nickname. ' ' .$name; ?></p>
                <p class="textcenter" style="font-family:Lato,sans-serif;text-align:center">Click the link below to activate your account</p>
                <a href="<?= $resetlink ?>">
                    <button class="large expand" href="#" style="font-family:Lato,sans-serif;height:50px;left:50%;margin:20px -100px;position:relative;top:50%;width:200px">ACTIVATE ACCOUNT</button>
                </a>
